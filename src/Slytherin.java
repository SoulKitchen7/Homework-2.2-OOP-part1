class Slytherin extends Hogwarts {
    ...
    public int sumOfSlytherinAbilities() {
        return cunning + determination + ambition + power + resourcefulness;
    }
    public int compareSlytherinStudent(Slytherin student) {
        if (sumOfSlytherinAbilities() > student.sumOfSlytherinAbilities()) {
